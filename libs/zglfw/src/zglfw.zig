...
pub const Window = opaque {
    ...
    pub fn setIcons(window: *Window, images: []Image) void {
        glfwSetWindowIcon(window, @intCast(images.len), @ptrCast(images));
    }
    extern fn glfwSetWindowIcon(window: *Window, count: i32, image: *const Image) void;
