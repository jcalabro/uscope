...
pub use model::{
    ...
    TypeReference, UnsupportedVariableFeature, UnwindTermination, ValueExpression, ValueGraph,
    ValueNode, ValueNodeId, ValueNodeState, Variable, VariableKind, VariableMalformedReason,
