...
pub fn parseFiles(allocator: Allocator) !void {
    ...
    const project_path = ".panacea/config.ini";
...
test "settings ini correctly parses" {
...

    {
        ...
        try testing.expectEqualStrings("/tmp/panacea.log", g.log.file);
    }
