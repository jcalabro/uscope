...
pub fn parseFiles(allocator: Allocator) !void {
    ...
    const project_path = ".inspect/config.ini";
...
test "settings ini correctly parses" {
...

    {
        ...
        try testing.expectEqualStrings("/tmp/inspect.log", g.log.file);
    }
